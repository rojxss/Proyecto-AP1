/**
 * Layout para /padre/* — verifica sesión y rol 'padre' en el servidor.
 */
...
export default async function PadreLayout({ children }: { children: React.ReactNode }) {
  ...
  if (profile.rol !== 'padre') redirect('/login')
  ...
  return (
    <>
      ...
      <div className="layout-app">
        <Sidebar nombreUsuario={profile.nombre_completo} rol="padre" />
